...
# Création d'une palette pour les différents groupes de religion.
# Christianisme : bleu, Islam : vert, autres : du jaune au violet.
palette_religion = c(
...
### Consommation d'alcool en fonction des 4 sous-religions du Christianisme
